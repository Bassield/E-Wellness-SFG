...
import com.sfg.EWellnessSFG.RecordInfo;
...
public class ConsultationAdapter  extends FirestoreRecyclerAdapter<Record, ConsultationAdapter.RecordsHolder>{

    public ConsultationAdapter(@NonNull FirestoreRecyclerOptions<Record> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull RecordsHolder holder, int position, @NonNull final Record model) {
